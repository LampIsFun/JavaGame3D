...
public class Terrain {
	...
	public float getY(float worldx, float worldz) {
		float tx = worldx - this.x;
		float tz = worldz - this.z;
		...
		float xCoord = (tx % gridSize) / gridSize;
		float zCoord = (tz % gridSize) / gridSize;
		float answer;
		if (xCoord <= (1 - zCoord)) {
